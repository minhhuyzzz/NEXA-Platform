...
import OrgSidebar from '../components/OrgSidebar'; // Import đúng từ thư mục organization
import { 
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        <header className="px-8 py-6 border-b border-slate-100 bg-white flex justify-between items-center shrink-0">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex items-center gap-2 px-5 py-3 bg-[#1e3a8a] text-white rounded-xl font-bold text-sm hover:bg-blue-900 shadow-lg">
