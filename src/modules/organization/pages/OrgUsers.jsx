...
// --- QUAN TRỌNG: Import đúng Sidebar của Organization ---
...
const OrgUsers = () => {
  ...
  // Lấy dữ liệu từ LocalStorage (người dùng vừa đăng ký)
  useEffect(() => {
    try {
      ...
      if (savedUser) {
        setUsers(prev => [{
          id: 999,
          name: savedUser.fullName || 'Người dùng mới',
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <div className="w-16 h-2 bg-slate-100 rounded-full overflow-hidden">
                          <div style={{width: `${(user.score || 0) / 10}%`}} className="h-full bg-[#1e3a8a]"></div>
                        </div>
...
// Component Badge trạng thái nhỏ gọn
